...
/**
 * 관람 가치 온보딩 — "이번 박람회에서 무엇을 남기고 싶으세요?"
 * 고른 관람 가치를 브레인에 시드해 피드가 즉시 그 방향으로 맞춰진다(companion-reframe §7.2).
 * 동선 최적화가 아니라 "무엇을 남길지"를 먼저 묻는 진입.
 */
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            오늘 관람의 관심 가치를 정하면 그 방향으로 골라드려요
          </p>
        </div>

...
export function OnboardingWizard({
  ...
  return (
    <div className="flex min-h-dvh flex-col landscape:fixed landscape:inset-0 landscape:z-30 landscape:bg-background">
      ...
      {/* Landscape: interests on the left, age + purpose + CTA on the right. */}
      <div className="flex-1 overflow-y-auto landscape:flex landscape:min-h-0 landscape:flex-row landscape:overflow-hidden">
        <div className="space-y-8 px-5 py-6 landscape:flex-1 landscape:space-y-0 landscape:overflow-y-auto">
          ...
          <section className="space-y-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                분야를 누르면 어떤 부스가 있는지 키워드로 보여드려요 · 여러 개
                선택 가능
              </p>
            </div>
        ...
        {/* Right column (landscape) — age + purpose. */}
        <div className="space-y-8 px-5 pb-6 landscape:w-[420px] landscape:shrink-0 landscape:space-y-8 landscape:overflow-y-auto landscape:border-l landscape:border-border landscape:py-6">
          {/* 2. 나이 */}
          <section className="space-y-3">
